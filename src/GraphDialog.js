...
const GraphDialogInner = ({ groupName, allHistory, groupList, onClose }) => {
    const [filterType, setFilterType] = (0, react_1.useState)('ALL');
    const [compareGroups, setCompareGroups] = (0, react_1.useState)(new Set());
    // 기준 그룹 필터링
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
        ...
        }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: '15px' }, children: [(0, jsx_runtime_1.jsxs)("h3", { style: { margin: 0, color: '#2c3e50' }, children: ["\uD83D\uDCCA ", groupName, " \uB2E4\uC911 \uBE44\uAD50"] }), (0, jsx_runtime_1.jsxs)("select", { value: filterType, onChange: e => setFilterType(e.target.value), style: { padding: '6px 10px', borderRadius: '4px', border: '1px solid #ccc' }, children: [(0, jsx_runtime_1.jsx)("option", { value: "ALL", children: "\uC804\uCCB4 API \uBCF4\uAE30" }), (0, jsx_runtime_1.jsx)("option", { value: "V1", children: "V1 (\uC21C\uC218 OCR)" }), (0, jsx_runtime_1.jsx)("option", { value: "V2", children: "V2 (\uC5D0\uC774\uC804\uD2B8)" })] })] }), (0, jsx_runtime_1.jsx)("button", { onClick: onClose, style: { border: 'none', background: 'transparent', fontSize: '1.5em', cursor: 'pointer', color: '#7f8c8d' }, children: "\u2716" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { padding: '10px', backgroundColor: '#f8f9fa', borderRadius: '8px', marginBottom: '20px', border: '1px solid #eee' }, children: [(0, jsx_runtime_1.jsx)("span", { style: { fontWeight: 'bold', fontSize: '0.9em', color: '#555', display: 'block', marginBottom: '8px' }, children: "\u2705 \uBE44\uAD50\uD560 \uADF8\uB8F9 \uC120\uD0DD (\uB2E4\uC911 \uC120\uD0DD \uAC00\uB2A5):" }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '15px' }, children: [groupList.filter(g => g !== groupName).map(g => ((0, jsx_runtime_1.jsxs)("label", { style: { cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', fontSize: '0.9em', color: '#2c3e50' }, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: compareGroups.has(g), onChange: (e) => {
